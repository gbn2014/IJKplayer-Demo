...
#define IJKMoviePlayerBufferingStartNotification IJKMPMoviePlayerBufferingStartNotification
#define IJKMoviePlayerBufferingEndNotification IJKMPMoviePlayerBufferingEndNotification
#define IJKMoviePlayerTimeDelayRealtimeNotification IJKMPMoviePlayerTimeDelayRealtimeNotification
#define IJKMoviePlayerTimeDelayRealtimeTimeKey IJKMPMoviePlayerTimeDelayRealtimeTimeKey
#define IJKMoviePlayerSnapoffCountRealtimeNotification IJKMPMoviePlayerSnapoffCountRealtimeNotification
#define IJKMoviePlayerSnapoffCountRealtimeCountKey IJKMPMoviePlayerSnapoffCountRealtimeCountKey
#define IJKMoviePlayerSnapoffCountRealtimeTimeKey IJKMPMoviePlayerSnapoffCountRealtimeTotalTimeKey
#define IJKMoviePlayerPlaybackErrorNotification IJKMPMoviePlayerPlaybackErrorNotification
#define IJKMoviePlayerPlaybackErrorTypeKey IJKMPMoviePlayerPlaybackErrorTypeKey

#define IJKMoviePlayerTimeInfoNotification IJKMPMoviePlayerTimeInfoNotification
#define IJKMoviePlayerTimeInfoTypeKey IJKMPMoviePlayerTimeInfoTypeKey
#define IJKMoviePlayerFirstKeyframeTimeKey IJKMPMoviePlayerFirstKeyframeTimeKey
#define IJKMoviePlayeHttpConnectTimeKey IJKMPMoviePlayerHttpConnectTimeKey
#define IJKMoviePlayerTcpConnectTimeKey IJKMPMoviePlayerTcpConnectTimeKey
#define IJKMoviePlayerDnsParseTimeKey IJKMPMoviePlayerDnsParseTimeKey

#define IJKMoviePlayerTcpSpeedNotification IJKMPMoviePlayerTcpSpeedNotification
#define IJKMoviePlayerTcpSpeedKey IJKMPMoviePlayerTcpSpeedKey
